...
func (r ApiGetStatusApiStatusGetRequest) Execute() (*Status, *http.Response, error) {
	return r.ApiService.GetStatusApiStatusGetExecute(r)
}
...
func (a *StatusAPIService) GetStatusApiStatusGetExecute(r ApiGetStatusApiStatusGetRequest) (*Status, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "StatusAPIService.GetStatusApiStatusGet")
	if err != nil {
