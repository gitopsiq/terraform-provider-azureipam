...
// checks if the ExtNetReq type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtNetReq{}
...
func (o *ExtNetReq) UnmarshalJSON(data []byte) (err error) {
	...
	varExtNetReq := _ExtNetReq{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExtNetReq)

	if err != nil {
		return err
	}

	*o = ExtNetReq(varExtNetReq)
...
func NewNullableExtNetReq(val *ExtNetReq) *NullableExtNetReq {
	return &NullableExtNetReq{value: val, isSet: true}
}
